$(document).ready(function () {
  ...
  function rain() {
    for (var i = 0; i < 500; i++) {
      ...
      grd.addColorStop(0.0, "rgba(10, 150, 160, 0.8)");
      grd.addColorStop(0.1, "rgba(10, 140, 160, 0.9)");
      grd.addColorStop(0.2, "rgba(10, 130, 150, 0.8)");
      grd.addColorStop(1, "rgba(10, 130, 140, .5)");
      ctx.fillStyle = grd;
